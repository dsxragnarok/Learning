...
function Game() {
	 ...
	 * This is to stop the animaiton script from constantly running on
	 * older browsers.
	 */
	 this.init = function()
	 {
...
/**
	* The animation loop. Calls the requestAnimationFrame shim to optimize the
	* game loop and draws all game objects. This function must be a global function
